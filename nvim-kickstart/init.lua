--function SedAlacrittyConf(line1, from1, to1, line2, from2, to2, fname)
--  vim.cmd(string.format("silent !sed -i '%ss/%s, y = %s/%s, y = %s/; %ss/%s/%s/' %s",
--    line1, from1, from1, to1, to1, line2, from2, to2, fname))
--end
--
--function IncreasePadding()
--  SedAlacrittyConf('38', '0', '10', '39', 'false', 'true', '~/.config/alacritty/alacritty.toml')
--end
--
--function DecreasePadding()
--  SedAlacrittyConf('38', '10', '0', '39', 'true', 'false', '~/.config/alacritty/alacritty.toml')
--end
--
--vim.cmd[[
